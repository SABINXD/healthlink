...
<head>
    ...
    <title>Menstrual Health Tracker - healthlink</title>
...
<body>
            ...
            <div class="header-content">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="assets/php/forum.php">Forum</a></li>
                        <li><a href="assets/php/professionals.php">Professionals</a></li>
                        <li><a href="assets/php/mensturation.php" class="active">Health Tracker</a></li>
                        <li><a href="assets/php/resources.php">Resources</a></li>
                    </ul>
                </nav>
                <div class="user-menu">
    ...
    <div class="container">
        ...
        <div class="mt-12">
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <p class="text-gray-600 mb-4">Leave a comment about your menstrual health journey or ask questions to the community.</p>
    ...
    <footer>
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-column">
                    ...
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li><a href="assets/php/forum.php">Forum</a></li>
                        <li><a href="assets/php/mensturation.php">Health Tracker</a></li>
                        <li><a href="assets/php/professionals.php">Health Professionals</a></li>
                        <li><a href="assets/php/resources.php">Resources</a></li>
                    </ul>
                </div>
                <div class="footer-column">
                    <h4>Health Topics</h4>
                    <ul>
                        <li><a href="assets/php/mensturation.php">Menstrual Health</a></li>
                ...
                <div class="footer-column">
                    <h4>Contact Us</h4>
                    <ul>
                        <li><i class="fas fa-envelope"></i> info@healthlink.com</li>
            ...
            <div class="copyright">
                <p>&copy; 2025 healthlink Forum. All rights reserved.</p>
            </div>
        </div>
    </footer>
    <script>
