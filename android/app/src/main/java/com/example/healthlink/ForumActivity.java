...
public class ForumActivity extends AppCompatActivity {
    ...
    private void handlePostSubmission() {
        ...
        newPost.setAuthor(sessionManager.getUserName()); // Use actual user name from session
        ...
        Toast.makeText(this, "Your question has been posted successfully!", Toast.LENGTH_SHORT).show();
    }
