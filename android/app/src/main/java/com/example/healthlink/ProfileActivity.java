...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void initializeComponents() {
        ...
        URL_PROFILE = "http://" + serverIp + "/healthlink/api/get_profile_info.php";
        URL_UPLOAD = "http://" + serverIp + "/healthlink/api/upload_profile_pic.php";
        URL_FOLLOW_STATS = "http://" + serverIp + "/healthlink/api/get_follow_stats.php";
        URL_USER_POSTS = "http://" + serverIp + "/healthlink/api/get_user_posts.php";
    ...
    private void setupProfilePostsRecyclerView() {
        if (profilePostsRecyclerView != null) {
            ...
            adapter = new PostAdapter(this, userPosts, sessionManager);
