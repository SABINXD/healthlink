...
public class NotificationsActivity extends AppCompatActivity {
    ...
    private void loadNotifications() {
        String url = "http://" + serverIp + "/healthlink/api/get_notifications.php?user_id=" + sessionManager.getUserId();
    ...
    private void handleFollowRequest(int followerId, String action) {
        String url = "http://" + serverIp + "/healthlink/api/handle_follow_request.php";
