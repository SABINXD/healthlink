...
public class UserProfileActivity extends AppCompatActivity {
    ...
    private ProfilePostAdapter adapter; // Changed to ProfilePostAdapter
    ...
    private void setupRecyclerView() {
        if (recyclerPosts != null) {
            ...
            // Use ProfilePostAdapter instead of UserPostAdapter
            adapter = new ProfilePostAdapter(this, userPosts, serverIp, sessionManager.getUserId());
            recyclerPosts.setAdapter(adapter);

            Log.d(TAG, "✅ RecyclerView setup complete with ProfilePostAdapter");
        }
    }
    ...
    private void loadUserProfile() {
        String url = "http://" + serverIp + "/healthlink/api/get_user_profile.php?user_id=" + targetUserId;
    ...
    private void checkFollowStatus() {
        String url = "http://" + serverIp + "/healthlink/api/check_follow_status.php?current_user_id=" +
    ...
    private void checkBlockStatus() {
        String url = "http://" + serverIp + "/healthlink/api/check_block_status.php?blocker_id=" +
    ...
    private void loadUserPosts() {
        ...
        String url = "http://" + serverIp + "/healthlink/api/get_user_posts.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                response -> {
                    try {
                        ...
                        Toast.makeText(this, "Error parsing post data", Toast.LENGTH_SHORT).show();
                    }
                },
                error -> {
    ...
    private Post createPostFromJson(JSONObject obj) throws Exception {
        ...
        // Handle AI summary
        String aiSummary = obj.optString("ai_summary", "");
        if (aiSummary != null && !aiSummary.equals("null") && !aiSummary.trim().isEmpty()) {
            post.setAiSummary(aiSummary);
        }
    ...
    private void updatePostsUI() {
        Log.d(TAG, "updatePostsUI called. isBlocked: " + isBlocked + ", posts size: " + userPosts.size());
    ...
    private void followUser() {
        String url = "http://" + serverIp + "/healthlink/api/follow_user.php";
    ...
    private void unfollowUser() {
        String url = "http://" + serverIp + "/healthlink/api/unfollow_user.php";
    ...
    private void performBlockUser() {
        String url = "http://" + serverIp + "/healthlink/api/block_user.php";
    ...
    private void performUnblockUser() {
        String url = "http://" + serverIp + "/healthlink/api/unblock_user.php";
